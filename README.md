...
- **Documentar mi progreso:** Registrar de manera ordenada el avance en conceptos fundamentales, intermedios y avanzados de diseño 3D en SolidWorks.
- **Práctica constante:** Resolver retos de modelado 3D, parametrización de piezas y ensamblajes mecánicos.
- **Proyectos aplicados:** Diseñar modelos completos aptos para manufactura, diseño industrial e impresión 3D.
- **Buenas prácticas CAD:** Aplicar diseño por intenciones, gestión eficiente del árbol de operaciones (FeatureTree), relaciones geométricas sólidas y control de versiones de archivos 3D con Git LFS.
